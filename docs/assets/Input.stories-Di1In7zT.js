import{j as W}from"./jsx-runtime-D_zvdyIk.js";import{I as v}from"./Input-D1JRHOdU.js";import"./index-D4lIrffr.js";/* empty css              */import"./Label-WHfwOnzY.js";import"./Icon-B-C3fS2t.js";import"./Spinner-Bp0FQ2cK.js";const Be={component:v,title:"Input/Input",decorators:[x=>W.jsx("div",{className:"div-input-stories",children:W.jsx(x,{})})],render:x=>W.jsx(v,{...x})},e={args:{name:"query",type:"text",placeholder:"Type your query"}},r={args:{...e.args,label:"Search",required:!0}},s={args:{...e.args,label:"Search the string",required:!0,labelPosition:"side"}},a={args:{...r.args,icon:"muncher"}},o={args:{...r.args,hoverIcon:"muncher",onHoverIconClick:()=>{console.log("hover icon clicked")}}},t={args:{...a.args,error:"Provide value for Search"}},n={args:{...e.args,type:"color"}},c={args:{...e.args,type:"date"}},p={args:{...e.args,type:"datetime-local"}},m={args:{...e.args,type:"email",placeholder:"Email",icon:"mail"}},l={args:{...e.args,type:"month"}},u={args:{...e.args,type:"number",placeholder:"Phone number",icon:"phone"}},i={args:{...e.args,type:"number",step:.5,placeholder:"Floating point number"}},g={args:{...e.args,type:"password",placeholder:"Type password"}},d={args:{...e.args,type:"range"}},h={args:{...e.args,type:"search"}},y={args:{...e.args,type:"tel"}},S={args:{...e.args,type:"time"}},f={args:{...e.args,type:"url",placeholder:"type url"}},D={args:{...e.args,type:"week"}},T={args:{...e.args,onEnterPress:()=>{console.log("Enter pressed")}}},b={args:{...e.args,displayLoader:!0,icon:"search"}};var E,I,P;e.parameters={...e.parameters,docs:{...(E=e.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    name: "query",
    type: "text",
