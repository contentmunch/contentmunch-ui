import{j as W}from"./jsx-runtime-D_zvdyIk.js";/* empty css                    */import{I as v}from"./Input-CW75_x4W.js";import"./index-D4lIrffr.js";/* empty css              */import"./Label-WHfwOnzY.js";import"./Icon-D34a5EjT.js";import"./Spinner-Bp0FQ2cK.js";const Ge={component:v,title:"Input/Input",decorators:[x=>W.jsx("div",{className:"div-input-stories",children:W.jsx(x,{})})],render:x=>W.jsx(v,{...x})},e={args:{name:"query",type:"text",placeholder:"Type your query"}},r={args:{...e.args,label:"Search",required:!0}},s={args:{...e.args,label:"Search the string",required:!0,labelPosition:"side"}},a={args:{...r.args,icon:"muncher"}},o={args:{...r.args,hoverIcon:"muncher",onHoverIconClick:()=>{console.log("hover icon clicked")}}},t={args:{...a.args,error:"Provide value for Search"}},n={args:{...e.args,type:"color"}},c={args:{...e.args,type:"date"}},p={args:{...e.args,type:"datetime-local"}},m={args:{...e.args,type:"email",placeholder:"Email",icon:"mail"}},l={args:{...e.args,type:"month"}},i={args:{...e.args,type:"number",placeholder:"Phone number",icon:"phone"}},u={args:{...e.args,type:"number",step:.5,placeholder:"Floating point number"}},g={args:{...e.args,type:"password",placeholder:"Type password"}},d={args:{...e.args,type:"range"}},h={args:{...e.args,type:"search"}},y={args:{...e.args,type:"tel"}},S={args:{...e.args,type:"time"}},f={args:{...e.args,type:"url",placeholder:"type url"}},D={args:{...e.args,type:"week"}},T={args:{...e.args,onEnterPress:()=>{console.log("Enter pressed")}}},b={args:{...e.args,displayLoader:!0,icon:"search"}};var E,I,P;e.parameters={...e.parameters,docs:{...(E=e.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    name: "query",
    type: "text",
...
}`,...(se=(ae=l.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var oe,te,ne;i.parameters={...i.parameters,docs:{...(oe=i.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    type: 'number',
...
}`,...(ne=(te=i.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var ce,pe,me;u.parameters={...u.parameters,docs:{...(ce=u.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    type: 'number',
    step: 0.5,
...
}`,...(ue=(ie=g.parameters)==null?void 0:ie.docs)==null?void 0:ue.source}}};var ge,de,he;d.parameters={...d.parameters,docs:{...(ge=d.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    type: 'range'
  }
...
}`,...(Ne=(He=b.parameters)==null?void 0:He.docs)==null?void 0:Ne.source}}};const Je=["Default","TextWithLabel","TextWithLabelOnTheSide","TextWithIcon","TextWithHoverIcon","WithError","Color","Date","DateTime","Email","Month","Number","Float","Password","Range","Search","Tel","Time","Url","Week","EnterPressed","WithSpinner"];export{n as Color,c as Date,p as DateTime,e as Default,m as Email,T as EnterPressed,u as Float,l as Month,i as Number,g as Password,d as Range,h as Search,y as Tel,o as TextWithHoverIcon,a as TextWithIcon,r as TextWithLabel,s as TextWithLabelOnTheSide,S as Time,f as Url,D as Week,t as WithError,b as WithSpinner,Je as __namedExportsOrder,Ge as default};
