import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as z}from"./index-D4lIrffr.js";import{I as i,d as D}from"./Icon-Bj0efVpV.js";import{I as E}from"./Input-CrnQviid.js";import{B as T}from"./Button-BkaHsfYs.js";/* empty css              */import"./Label-WHfwOnzY.js";const R={component:i,title:"Visual/Icons",argTypes:{color:{control:"color"}},render:s=>e.jsx("div",{children:e.jsx(i,{...s})})},a=()=>{const[s,w]=z.useState("");return e.jsxs("div",{className:"icon-search-story",children:[e.jsx(E,{name:s,onChange:r=>w(r.target.value),icon:"search"}),Object.keys(D).filter(r=>r.search(new RegExp(s.replace(/\s*/g,""),"i"))>-1).map(r=>e.jsx(T,{size:"small",rounded:!0,title:r,variant:"tertiary",children:e.jsx(i,{iconString:r})},r))]})},n={args:{name:"muncher",size:"small"}},t={args:{...n.args,size:"medium",weight:1}},o={args:{...t.args,weight:2}},c={args:{name:"muncher",size:"small",orientation:"left"},render:s=>e.jsx("div",{children:e.jsx(i,{...s,children:e.jsx("p",{children:"Text"})})})};a.__docgenInfo={description:"",methods:[],displayName:"Search"};var m,u,d;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`() => {
