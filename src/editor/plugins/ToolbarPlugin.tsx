...
import "./assets/toolbar-plugin.css";
import {
    $createParagraphNode,
    $getSelection,
    $isRangeSelection,
...
export const ToolbarPlugin: React.FC<ToolbarPluginProps> = ({setIsLinkEditMode, variant}) => {
    ...
    // Undo/redo availability is tracked via CAN_UNDO_COMMAND/CAN_REDO_COMMAND below,
    // but this toolbar variant doesn't render undo/redo buttons, so we only need to
    // keep the listeners registered (no state to read back).
